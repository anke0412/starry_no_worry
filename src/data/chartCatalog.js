...
export const chartCategories = [
  ...
  {
    id: "davison-progression",
    mode: "forecast",
    label: "时空中点盘次限盘",
    outputTitle: "时空中点盘次限盘",
    requiresSecondPerson: true,
    requiresForecastDate: true,
  ...
  {
    id: "composite-tertiary-progression",
    mode: "forecast",
    label: "组合盘三限盘",
    outputTitle: "组合盘三限盘",
    requiresSecondPerson: true,
    requiresForecastDate: true,
    focus: ["短周期关系气候", "情绪波动", "关系转折", "阶段触发"],
  },
  {
    id: "davison-tertiary-progression",
    mode: "forecast",
    label: "时空中点盘三限盘",
    outputTitle: "时空中点盘三限盘",
    requiresSecondPerson: true,
    requiresForecastDate: true,
